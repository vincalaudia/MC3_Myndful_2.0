...
struct Activities : Identifiable{
    ...
    var viewDestination : String
    
    init(title:String, type:String, image : Image, time:String, description : String, viewDestination: String){
        self.title = title
        self.type = type
        self.image = image
        self.time = time
